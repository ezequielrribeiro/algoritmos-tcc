...
/**
 * Classe auxiliar para carregar os artefatos utilizados durante o processo
 * de etração de esquemas a partir de fontes de dados JSON
 * @author ezequielrr
 */
public class CarregarDoArquivo {
    ...
    public List<List<String>> listaReferencias1(String arquivo) throws FileNotFoundException {
    ...
    public List<String[]> listaReferencias2(String arquivo) throws FileNotFoundException {
