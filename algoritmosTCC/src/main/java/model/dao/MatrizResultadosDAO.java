...
public class MatrizResultadosDAO {
    ...
    private MatrizResultados lerMatrizUnicaResultados(String arquivoCampos,
            String arquivoMatriz) throws FileNotFoundException {
    ...
    private List<String> lerCamposMatrizUnicaResultados(String arquivo)
            throws FileNotFoundException {
